        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-title">                    
                    <h2><span onclick="back();"class="fa fa-arrow-circle-o-left"></span>&nbsp;&nbsp;Add Employee</h2>
                </div>
                <!-- END PAGE TITLE -->                
 ...
 <input type="password" class="form-control c" name="cpassword" id="cpassword"  placeholder="confirm-Password" required>
    ...
    <div class="form-group group1">        
      <div class="col-sm-offset-5 col-sm-10">
        <button type="submit"  class="btn btn-success " >Add</button> <button type="reset"  class="btn btn-danger" >Clear</button>
...
{ 
    ...
    $.ajax({
                url: 'ajax/addemployee.php', // point to server-side PHP script 

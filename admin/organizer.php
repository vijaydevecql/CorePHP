   ...
   ?> 
    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Organiser's</li>
                </ul>
                <!-- END BREADCRUMB -->
                
                <!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2><span onclick="back();"class="fa fa-arrow-circle-o-left"></span> Organiser's Record</h2>
                </div>
                <!-- END PAGE TITLE -->                
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Organiser's Record</h3>
                                                     
                                    <div class="btn-group pull-right">
                                        <button class="btn btn-danger" onclick="goadd();" >Organiser's Add</button>
      ...
      <tr>
		...
		<th><center>View Employee</center></th>
...
<td><center><a href="viewemployee?id=<?php echo $row['id']; ?>"class="btn btn-danger">View </a></center></td>
...
function chl(pk){
  ...
  if(confirm('Are you sure want to delete this Organiser?')){
    var del_id=pk;
    $.ajax({
                type:'POST',
                url:'ajax/delete.php',

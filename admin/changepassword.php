        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-title">                    
                    <h2><span onclick="back();"class="fa fa-arrow-circle-o-left"></span> Change Password</h2>
                </div>
                <!-- END PAGE TITLE -->                
                                    ...
                                    <div class="container1">
                                        ...
                                        <form class="form-horizontal" id="form" method="post">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="password" class="form-control" name="cp" id="cp" placeholder="Current Password" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" for="email">New Password:</label>
                                                <div class="col-sm-10">
                                                    <input type="password" class="form-control" name="np" id="np" placeholder="New Password" required>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-2" for="email">Confirm Password:</label>
                                                <div class="col-sm-10">
                                                    <input type="password" class="form-control" name="ccp" id="ccp" placeholder="Confirm Password" required>
                                                </div>
                                            </div>
                                            <div class="form-group">        

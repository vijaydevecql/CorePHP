...
<?php include("sidebar.php"); ?>
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">Audio Books</li>
            </ul>
            <!-- END BREADCRUMB -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Audio Books Record</h3>
                            ...
                            <div class="panel-body">
                                <table id="customers1" class="table datatable">
                                    ...
                                    <th><center>Listen Audio</center></th>
...
<?php
$i = 1;
foreach ($admin->getallbook(1)['data'] as $row) {
    ?>
                                        ...
                                        <td><center><a class="btn btn-info"  data-toggle="modal" onclick='getaudio(<?php echo json_encode($row['audio_urls']); ?>)' data-target="#myModal"><i class="fa fa-file-audio-o" aria-hidden="true"></i></a></td>
...
<?php include("footer.php"); ?>
    ...
    <div id="myModal" style="" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Listen Audio</h4>
                </div>
                <div class="modal-body audios">
    ...
    <script>
                                            ...
                                            function getaudio(str) {
                                                ...
                                                for (var d = 0; d < data.length; d++) {
                                                    $(".audios").append('<div align="center" style="border: 1px solid ; margin-bottom: 1cm;" class="p"><audio controls class="p"><source src="' + data[d]['audio_url'] + '" type="audio/ogg"><source src="' + data[d]['audio_url'] + '" type="audio/mpeg"></audio></div>');
                                                }
